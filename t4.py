...
def fetch_article_ingredients():
    try:
        ...
        select_query = "SELECT * FROM article_ingredients LIMIT 100;"
        ...
        if rows:
            ...
            print(f"\nShowing first {len(rows)} rows from 'article_ingredients':")
            ...
            print("⚠️ No data found in 'article_ingredients'.")
